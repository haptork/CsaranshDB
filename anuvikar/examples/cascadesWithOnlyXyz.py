...
from anuvikarpp import getDefaultConfig, getDefaultInfos, processXyzFilesInDirGivenInfo, processXyzFileGivenInfo
...
# saves a js file that can be visualized in anuvikar web-app as we are doing next
jsFile = "local-Fe.js"
...
#  --------------------------------
#  
#  returned with getDefaultConfig(). Can be changed such as `config['anuvikarLib'] = "../libanuvikar.dlib"`, `config['onlyDefects'] = True` etc.
...
#     
# all options for infos:
#  --------------------------------
# 
#   - InputInfo: Can be changed such as `info['xyzFilePath'] = "./final.xyz"`, `info['latticeConst'] = 3.165` etc.
...
# 
#   - ExtraIfno: Mostly optional, Can be changed such as `extraInfo['energy'] = 5`, `info['substrate'] = "W"` etc.
...
#     - energy: default(0.0)
#     - simulationTime: default(0.0)
#     - id: default(1)
#     - xyzFileName: default("")
#     - infilePath: default("")
#     - tags: default("")
#     - name: default("")
#     - potentialUsed: default("")
#     - author: default("")
